...
attack1Stru = new attacksDesribtion(0.95, 70, 15, dmgType.melee, 0.3, 0.1,
...
attack2Stru = new attacksDesribtion(0.8, 40, 8, dmgType.melee, 0.15, 0.1,
...
attack3Stru = new attacksDesribtion(0.6, 30, 9, dmgType.melee, 0.18, 0.2,
